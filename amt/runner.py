...
* consistency check
* reasoning
* export TTL, Cypher, HTML

Usable as a library function or as ``python -m amt.runner input.ttl``.

Output files are placed next to the input by default, named after its stem:
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--no-info", action="store_true",
                   help="Skip ontology summary printout")
